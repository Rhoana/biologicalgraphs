...
void CppTeaserSkeletonization(const char *prefix, long skeleton_resolution[3], double input_scale, long input_buffer) 
{
    ...
    sprintf(input_filename, "benchmarks/skeleton/%s-downsample-%03ldx%03ldx%03ld.bytes", prefix, skeleton_resolution[IB_X], skeleton_resolution[IB_Y], skeleton_resolution[IB_Z]);
    ...
    sprintf(output_filename, "benchmarks/skeleton/%s-teaser-%03ldx%03ldx%03ld-downsample-%02ld-%02ld-skeleton.pts", prefix, skeleton_resolution[IB_X], skeleton_resolution[IB_Y], skeleton_resolution[IB_Z], (long)(10 * scale), buffer);
